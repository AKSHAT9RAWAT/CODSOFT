...
double calculateTotalCost(int numSeats) {
    const double TICKET_PRICE = 300.0;
...
int main() {
    ...
    int numSeats;
    cout << "Let's buy you tickets to your favourite movie!\n";
    cout << "Enter the number of seats you want to book: ";
    cin >> numSeats;

    // Displaying initial seating arrangement
    displaySeatingChart(seatingChart);

    // Seating selection loop
    ...
    // Calculate and displaying the total cost
